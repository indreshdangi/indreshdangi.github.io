...
const IMAGES = {
  personal: [
    {
      id: 1,
      caption: "Field visit to understand farmer problems 🌾🚜",
      photos: ["/gallery/field1.jpg", "/gallery/field2.jpg"],
    },
    {
      id: 2,
      caption:
        "Late night coding sessions building IND Services 💻☕",
      photos: ["/gallery/setup.jpg"],
    },
  ],
  projects: [
    {
      id: 1,
      caption:
        "IND Services AI Chatbot - Solving user queries with Generative AI.",
      photos: ["/gallery/chatbot.png", "/gallery/chatbot2.png"],
    },
    
    {
      id: 2,
      caption:
        "IND Services Web Platform - Digital presence for modern businesses.",
      photos: ["/gallery/indservices.png", "/gallery/indservices2.png"],
    },
  ],
  achievements: [
    {
      id: 1,
      caption: "Founded IND Services - My Entrepreneurial Journey 🚀",
      photos: ["/gallery/startup.jpg"],
    },
    {
      id: 2,
      caption: "Leading Tech & Agri Initiatives in local community 🤝",
      photos: ["/gallery/leadership.jpg"],
    },
  ],
};
