...
// ✅ Updated Skills for Indresh Dangi
const SKILLS = [
  ...
  { name: "Gen AI", logo: "https://upload.wikimedia.org/wikipedia/commons/0/04/ChatGPT_logo.svg" },
  { name: "Git", logo: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/git/git-original.svg" },
  { name: "Agritech", logo: "https://cdn-icons-png.flaticon.com/512/4213/4213653.png" }, // Leaf/Agri placeholder
  { name: "Startup", logo: "https://cdn-icons-png.flaticon.com/512/1006/1006517.png" }, // Rocket/Startup placeholder
];

const ROWS = [
  [
    { title: "Data Analytics", items: ["Microsoft Excel (Advanced)", "SQL (Basics)", "Power BI", "Data Cleaning", "Statistics"] },
    { title: "Web Development", items: ["HTML5 & CSS3", "JavaScript", "React (Basic)", "Responsive Design"] },
    { title: "AI & Modern Tools", items: ["Generative AI (Applied)", "Prompt Engineering", "Basic ML Concepts", "AI Workflows"] },
    { title: "Business & Agritech", items: ["Entrepreneurship", "Agritech Knowledge", "Startup Operations", "Client Communication"] },
  ],
  [
    {
    ...
    {
      title: "Soft Skills",
      items: ["Leadership", "Problem Solving", "Public Speaking", "Decision Making", "Adaptability"],
    },
  ],
];
    ...
    <section className="skills-container" id="skills">
      ...
      >
        ...
        <p className="text-gray-400 text-lg max-w-xl mx-auto">
          ✨ Integrating Technology, Data, and Agriculture — explore my core competencies below.
        </p>
      </motion.div>
